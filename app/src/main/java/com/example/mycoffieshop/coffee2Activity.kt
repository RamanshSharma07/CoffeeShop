...
import com.example.mycoffieshop.ui.theme.ui.theme.ui.theme.MyCoffieShopTheme

class coffee2Activity : ComponentActivity() {
    ...
    Column {
        ...
        Row (modifier = Modifier.background(Color.White).padding(16.dp)) {
            Column (modifier = Modifier.weight(1f)){
                ...
                Text(text = "$ 3.53", color = Color(0XFFC67C4E))
            }
            Icon(
...
fun GreetingPreview4() {
    com.example.mycoffieshop.ui.theme.ui.theme.MyCoffieShopTheme {
        Greeting2()
    }
}